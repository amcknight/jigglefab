...
threeBallInner =
  ...
  -- orbStruct (Orb ( 1.0, 0.6) (vale 1)) <>
  -- orbStruct (Orb ( 1.2, 0.6) (vale 2)) <>
  -- orbStruct (Orb (-1.2, 0.6) (vale 3)) <>
  orbStruct (Orb ( 2.0, 0.6) (vale 1)) <>
  orbStruct (Orb ( 2.2, 0.6) (vale 2)) <>
  orbStruct (Orb (-2.2, 0.6) (vale 3))
