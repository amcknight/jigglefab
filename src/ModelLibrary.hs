...
fourChains rad ch = do
  f1 <- chainForm rad 150 1 (-800, 800) (-100, 100) ch
  f2 <- chainForm rad 150 1 ( 800, 800) ( 100, 100) ch
  f3 <- chainForm rad 150 1 ( 800,-800) ( 100,-100) ch
  f4 <- chainForm rad 150 1 (-800,-800) (-100,-100) ch
